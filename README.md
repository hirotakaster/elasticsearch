...
And this Dockerfile install <s>[kuromoji](https://github.com/elasticsearch/elasticsearch-analysis-kuromoji)</s>, [Marvel](https://www.elastic.co/downloads/marvel) plugin.
